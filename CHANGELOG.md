...
- **The downloads now carry Qt 6.11.3 in place of 6.8.3**
  Qt's own list of known vulnerabilities names 6.8.3, and by the time
  of this release it named 6.11.2 as well. None of those advisories
  reaches a part of Qt this app uses, but the downloads should not carry
  a version with published fixes it lacks. SECURITY.md § Bundled Qt records the
  check. Tracked as GHUB-0193.
